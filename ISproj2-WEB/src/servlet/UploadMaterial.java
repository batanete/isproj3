...
public class UploadMaterial extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(courseName + materialName + file + institutionalEmail);
		final String dir = System.getProperty("user.dir");
		System.out.println("current dir = " + dir);
		// pb.addMaterial(institutionalEmail, courseName, file, data);
		pb.addMaterial(institutionalEmail, courseName, materialName, file);
		response.sendRedirect("professormaterial.jsp");
