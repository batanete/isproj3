...
public class SearchStudent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<String> studentsList = pb.getStudentInfo(name, address, institutionalEmail, alternativeEmail, phone, number);

		request.setAttribute("students", studentsList);	
		RequestDispatcher view = request.getRequestDispatcher("professoruser.jsp");
