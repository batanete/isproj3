...
public class DeleteUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String institutionalEmail = request.getParameter("institution_email");
		
		if(ab.deletePerson(institutionalEmail)){
			setOnLoadMessage(request,"user deleted");
		}
		else{
			setOnLoadMessage(request,"user could not be deleted");
		}
