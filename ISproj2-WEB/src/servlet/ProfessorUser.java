...
/**
 * Servlet implementation class ProfessorUser
 */
@WebServlet("/ProfessorUser")
public class ProfessorUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("professoruser.jsp");
