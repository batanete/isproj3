...
/**
 * Servlet implementation class ProfessorMaterial
 */
@WebServlet("/ProfessorMaterial")
public class ProfessorMaterial extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("professormaterial.jsp");
