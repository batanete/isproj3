...
/**
 * Servlet implementation class ProfessorMenu
 */
@WebServlet("/ProfessorMenu")
public class ProfessorMenu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("professormenu.jsp");
