	...
	<div class="container-fluid">
		...
		<div>
			<ul class="nav navbar-nav side-nav">
				<li class=""><a href="professormenu.jsp"><i class="fa fa-home"></i>Home</a></li>
				<li><a href="professoruser.jsp"><i class="fa fa-user"></i> Search Users</a>
				<li><a href="professorcourse.jsp"><i class="fa fa-book"></i>
						Courses</a></li>
				<li><a href="professormaterial.jsp"><i class="fa fa-download"></i>Materials</a></li>
			</ul>
		</div>
		</div>
					...
					<div class="col-lg-12">
						...
						<div style="margin-bottom: 20px;">
							...
							<li><button class="list_materials activeUsers" data-toggle="tab">List Materials in Course</button></li>
								...
								<li><button class="upload " data-toggle="tab">Upload
										Material in Course</button></li>
						...
						<div class="transfer_material">
							<div class="row">
								<form method="post" action="TransferMaterial">
									<div class="form-group col-lg-4">
										<label for="exampleInputEmail1">Course Name</label> <input
											 class="form-control" name="course_name" id="exampleInputEmail1"
											aria-describedby="emailHelp" >
						...
						<div class="upload_material">
							<div class="row">
								<form method="post" action="UploadMaterial">
									...
									<div class="form-group col-lg-3">
										<label for="exampleInputEmail1">Material name Name</label> <input
											 class="form-control" name="material_name" id="exampleInputEmail1"
											aria-describedby="emailHelp">
									</div>
									...
									<div class="form-group col-lg-3">
										<label for="exampleInputFile">File input</label> <input
											type="file" style="" name="file" class="form-control-file"
											id="exampleInputFile" aria-describedby="fileHelp">
									</div>
									<div class="form-group col-lg-6" style="float:right;">
										<button type="submit" class="btn btn-primary col-lg-4"
											style="margin-top: 25px; float:right; ">Upload
											Material</button>
									</div>
								</form>
							</div>
						...
						<div class="list_materials_course">
							<div class="row">
								<form method="post" action="ListMaterial">
									<div class="form-group col-lg-4">
									<label for="exampleInputEmail1">Course Name</label> <input
										 class="form-control" name="course_name" id="exampleInputEmail1"
										aria-describedby="emailHelp">
