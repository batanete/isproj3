	...
	<div class="container-fluid">
		...
		<div>
			<ul class="nav navbar-nav side-nav">
				<li class=""><a href="studentmenu.jsp"><i class="fa fa-home"></i> Home</a></li>
				<li><a href="studentmaterial.jsp"><i class="fa fa-download"></i> Materials</a></li>
			</ul>
		</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="list_materials_course">
							<div class="row">
								<form method="post" action="ListMaterialStudent">
									<div class="form-group col-lg-4">
									<label for="exampleInputEmail1">Course Name</label> <input
										 class="form-control" name="course_name" id="exampleInputEmail1"
										aria-describedby="emailHelp">
